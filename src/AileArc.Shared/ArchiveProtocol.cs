...
public sealed record ScanRequest(int Version, string Path, string Operation = "scan", string? Password = null, ulong ByteLimit = 4UL * 1024 * 1024 * 1024);
...
public sealed record ScanMessage(string Kind, string? Format = null, ArchiveEntry[]? Entries = null, string? ErrorCode = null,
    long? EntryId = null, byte[]? Data = null, int? Result = null, ArchiveIdentity? Identity = null);
